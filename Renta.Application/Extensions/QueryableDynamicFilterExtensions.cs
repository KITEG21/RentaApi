...
public static class QueryableDynamicFilterExtensions
{
    ...
    public static IQueryable<T> ToDynamic<T>(
            ...
            IEnumerable<IFilterRequest>? filters = null,
            IEnumerable<ISortRequest>? sorts = null)
    {
    ...
    private static IQueryable<T> Filter<T>(IQueryable<T> queryable, IEnumerable<IFilterRequest> filters)
    {
    ...
    private static string Transform(IEnumerable<IFilterRequest> filters)
    {
        var index = 0;
    ...
    private static IQueryable<T> Sort<T>(IQueryable<T> queryable, IEnumerable<ISortRequest> sorts)
    {
